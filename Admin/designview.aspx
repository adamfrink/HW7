...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="464px" AutoGenerateRows="False" DataKeyNames="Id" CssClass="dtviewbg"  DataSourceID ="SqlDataSource1" AllowPaging="True">
        <Fields>
